...
epilep_delay = 100 # [ms]: start time of stim
...
epilep_stim.delay = epilep_delay  # [ms], added delay here to see if hyperpolarization before intracellular stimulation 
...
epilep_stim_wave_plot[int((epilep_dur+epilep_delay)/h.dt):-1] = 0
e1_stim_wave_plot = e1_stim_wave
e1_stim_wave_plot[int((e1_dur+e1_delay)/h.dt):-1] = 0
if epilep_delay > 0:
