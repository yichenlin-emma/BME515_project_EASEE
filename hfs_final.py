...
epilep_amp = 1 # [mA]: amplitude of (intracellular) stim object (negative cathodic, positive anodic), chosen amplitude
...
# Study Stimulation
e1_stim_wave_pos = e1_amp/2 * signal.square(2 * np.pi * e1_f * (t-0.09), duty=0.008) + e1_amp/2 # positive portion
e1_stim_wave_neg = -e1_amp/2 * signal.square(2 * np.pi * e1_f * (t-0.01), duty=0.008) - e1_amp/2 # negative portion
